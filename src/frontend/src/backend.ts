...
import type { ContactInfo as _ContactInfo, ExternalBlob as _ExternalBlob, ModelStats as _ModelStats, Photo as _Photo, PhotoCategory as _PhotoCategory, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getPhotosByCategory(arg0: PhotoCategory): Promise<Array<Photo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotosByCategory(to_candid_PhotoCategory_n11(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reorderPhotos(arg0: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderPhotos(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePhoto(arg0: Photo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePhoto(await to_candid_Photo_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSectionOrder(arg0: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSectionOrder(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PhotoCategory_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PhotoCategory): PhotoCategory {
...
function from_candid_opt_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContactInfo]): ContactInfo | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ModelStats]): ModelStats | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: from_candid_PhotoCategory_n19(_uploadFile, _downloadFile, value.category)
    };
}
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "commercial" in value ? PhotoCategory.commercial : "editorial" in value ? PhotoCategory.editorial : "runway" in value ? PhotoCategory.runway : "lifestyle" in value ? PhotoCategory.lifestyle : value;
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Photo>): Promise<Array<Photo>> {
...
function to_candid_PhotoCategory_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoCategory): _PhotoCategory {
...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        createdAt: value.createdAt,
        caption: value.caption,
        category: to_candid_PhotoCategory_n11(_uploadFile, _downloadFile, value.category)
    };
}
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PhotoCategory): {
    commercial: null;
} | {
    editorial: null;
} | {
    ...
    return value == PhotoCategory.commercial ? {
        commercial: null
    } : value == PhotoCategory.editorial ? {
        editorial: null
    } : value == PhotoCategory.runway ? {
        runway: null
    } : value == PhotoCategory.lifestyle ? {
        lifestyle: null
    } : value;
}
